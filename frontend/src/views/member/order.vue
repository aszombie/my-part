<template>
    <div class="main">
        <div class="lineDiv">
            ...
            <div class="mainTitle" v-if="innerWidth > 800">歷史訂單</div>
        </div>
        <div class="lineDiv">
            <table v-if="innerWidth <= 800" tabindex="0" @focus="open" @blur="close">
                <tbody>
                    <tr style="color: #dfa974;" @click="toOrder">歷史訂單</tr>
        ...
        <div class="lineDiv">
            ...
            <div>
                <!-- <customerOrder style="width: 1180px;"></customerOrder> -->
...
// import customerOrder from '@/views/Order/CustomerControllerOrder.vue'
